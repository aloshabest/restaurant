...
class TestMenu:
    ...
    def test_menu_post_and_patch(self, client):
        ...
        menu_patch = client.patch(f"/api/v1/menus/{MenuData.id}", json=data_patch)
...
class TestSubmenu:
    ...
    def test_submenu_post_and_get(self, client):
        data_submenu = {"menu_id": MenuData.id, "title": "My test submenu",
                        "description": "My test submenu description"}
        submenu_post = client.post(f"/api/v1/menus/{MenuData.id}/submenus", json=data_submenu)
        ...
        submenu_response = client.get(f"/api/v1/menus/{MenuData.id}/submenus/{response_submenu_post['id']}")
    ...
    def test_submenu_delete_and_get(self, client):
        submenu_delete_response = client.delete(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}")
    ...
    def test_submenu_post_and_patch(self, client):
        data_submenu = {"menu_id": MenuData.id, "title": "My test submenu",
                        "description": "My test submenu description"}
        submenu_post = client.post(f"/api/v1/menus/{MenuData.id}/submenus", json=data_submenu).json()
        SubmenuData.id = submenu_post['id']

        data_patch = {"title": "My update test submenu 1", "description": "My update test submenu description 1"}
        submenu_patch = client.patch(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}",
                                     json=data_patch)
...
class TestDish:
    def test_dish_get_empty(self, client):
        response = client.get(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}/dishes")
        assert response.status_code == 200, (
            f'Ожидается код 200, получен: {response.status_code}/'
        )
    ...
    def test_dish_post_and_get(self, client):
        data_dish = {"submenu_id": SubmenuData.id, "title": "My test dish",
                     "description": "My test dish description", "price": 11.11}
        dish_post = client.post(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}/dishes", json=data_dish)
        ...
        dish_response = client.get(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}/dishes/{DishData.id}")
        ...
        submenu_response = client.get(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}")
        submenu_response_data = submenu_response.json()
    ...
    def test_dish_post_and_patch(self, client):
        data_dish = {"submenu_id": SubmenuData.id, "title": "My test dish",
                     "description": "My test dish description", "price": 11.11}
        dish_post = client.post(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}/dishes", json=data_dish).json()
        DishData.id = dish_post['id']

        data_patch = {"title": "My update test dish 1", "description": "My update test dish description 1",
                      "price": 15.22}
        dish_patch = client.patch(f"/api/v1/menus/{MenuData.id}/submenus/{SubmenuData.id}/dishes/{DishData.id}",
                                  json=data_patch)
